  ...
  <div class="modal-body">
    <form id="form">
      ...
      <div class="form-group">
        ...
        <input type="text" class="form-control" placeholder="Satuan 1" name="satuan" required>
      </div>
      <div class="form-group">
        <label>Satuan</label>
        <select name="satuan" id="satuan" class="form-control" placeholder="Satuan" name="satuan"></select>
      </div>
      <div class="form-group">
        <label>Kategori</label>
        <select name="kategori" id="kategori" class="form-control" placeholder="Kategor" name="kategori" ></select>
      </div>
      <div class="form-group">
        <label>Harga</label>
