...
class Produk_model extends CI_Model {
	...
	{
		$this->db->select('produk.id, produk.nama_produk, produk.harga, produk.stok, kategori_produk.kategori, satuan_produk.satuan');
	...
	{
		$this->db->select('produk.id,  produk.nama_produk, produk.harga, produk.stok, kategori_produk.id as kategori_id, kategori_produk.kategori, satuan_produk.id as satuan_id, satuan_produk.satuan');
		$this->db->from($this->table);
		$this->db->join('kategori_produk', 'produk.kategori = kategori_produk.id');
		$this->db->join('satuan_produk', 'produk.satuan = satuan_produk.id');
	...
	{
		$this->db->select('stok, nama_produk, harga');
		$this->db->where('id', $id);
		return $this->db->get($this->table)->row();
	}
